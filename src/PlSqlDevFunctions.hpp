...
extern "C"
{
    ...
    __declspec(dllexport) const char* IdentifyPlugIn(int);
    ...
    __declspec(dllexport) const char* CreateMenuItem(int);
...
/*FUNC: 5*/ extern const char*(*SYS_OCIDLL)();
...
// )
// Available in version 700
/*FUNC: 8*/ extern const char* (*SYS_TNSNAMES)(const char*Param);
// IDE functions
...
/*FUNC: 12*/ extern void (*IDE_GetConnectionInfo)(const char**Username, const char**Password, const char**Database);

// Returns information about the selected item in the Browser. If no item is selected, all items are empty.
/*FUNC: 13*/ extern void (*IDE_GetBrowserInfo)(const char**ObjectType, const char**ObjectOwner, const char**ObjectName);
...
// 5 = Plan Window
// 6 = Report Window
/*FUNC: 20*/ extern void (*IDE_CreateWindow)(int WindowType, const char*Text, BOOL Execute);
...
/*FUNC: 21*/ extern BOOL (*IDE_OpenFile)(int WindowType, const char*Filename);
...
/*FUNC: 23*/ extern const char*(*IDE_Filename)();
...
//
// Available in version 300
/*FUNC: 27*/ extern BOOL (*IDE_ExecuteSQLReport)(const char*SQL, const char*Title, BOOL Updateable);
...
/*FUNC: 29*/ extern void (*IDE_SetFilename)(const char*Filename);
...
/*FUNC: 32*/ extern const char*(*IDE_GetCursorWord)();
...
//
// Available in version 213
/*FUNC: 34*/ extern BOOL (*IDE_SetText)(const char*Text);

// Places a message in the status bar of the current window, returns false if the window did not
// have a status bar.
//
// Available in version 213
/*FUNC: 35*/ extern BOOL (*IDE_SetStatusMessage)(const char*Text);
...
//
// Available in version 300
/*FUNC: 60*/ extern const char*(*IDE_GetCustomKeywords)();
...
//
// Available in version 300
/*FUNC: 61*/ extern void (*IDE_SetCustomKeywords)(const char*Keywords);
...
// Available in version 300
/*FUNC: 62*/ extern void (*IDE_SetKeywords)(int ID, int Style, const char*Keywords);
...
// Available in version 300
/*FUNC: 65*/ extern void (*IDE_SetMenuName)(int ID, int Index, const char*Name);
...
//
// Available in version 300
/*FUNC: 68*/ extern const char*(*IDE_GetMenulayout)();
...
//
// Available in version 300
/*FUNC: 69*/ extern void* (*IDE_CreatePopupItem)(int ID, int Index, const char*Name, const char*ObjectType);
...
// Available in version 301
/*FUNC: 70*/ extern BOOL (*IDE_SetConnection)(const char*Username, const char*Password, const char*Database);
...
//
// Available in version 400
/*FUNC: 71*/ extern int (*IDE_GetObjectInfo)(const char*AnObject, const char**ObjectType, const char**ObjectOwner, const char**ObjectName, const char**SubObject);
...
//
// Available in version 400
/*FUNC: 72*/ extern const char*(*IDE_GetBrowserItems)(const char*Node, BOOL GetItems);
...
/*FUNC: 73*/ extern void (*IDE_RefreshBrowser)(const char*Node);
...
//
// Available in version 400
/*FUNC: 74*/ extern int (*IDE_GetPopupObject)(const char**ObjectType, const char**ObjectOwner, const char**ObjectName, const char**SubObject);

// This function returns the name of browser root item for which a popup menu (created with
// IDE_CreatePopupItem) was activated.
//
// Available in version 400
/*FUNC: 75*/ extern const char*(*IDE_GetPopupBrowserRoot)();
...
//
// Available in version 400
/*FUNC: 76*/ extern void (*IDE_RefreshObject) (const char*ObjectType, const char*ObjectOwner, const char*ObjectName, int Action);
...
/*FUNC: 77*/ extern BOOL (*IDE_FirstSelectedObject)(const char*ObjectType, const char*ObjectOwner, const char*ObjectName, const char*SubObject);
...
//
// Available in version 500
/*FUNC: 78*/ extern BOOL (*IDE_NextSelectedObject)(const char*ObjectType, const char*ObjectOwner, const char*ObjectName, const char*SubObject);
...
/*FUNC: 79*/ extern const char*(*IDE_GetObjectSource)(const char*ObjectType, const char*ObjectOwner, const char*ObjectName);
...
// Available in version 303
/*FUNC: 92*/ extern void (*IDE_SplashWrite)(const char*s);

// Add text to the splash screen beginning on the next line.
// Available in version 303
/*FUNC: 93*/ extern void (*IDE_SplashWriteLn)(const char*s);
...
// Available in version 400
/*FUNC: 95*/ extern const char*(*IDE_TemplatePath)();
...
//
// Available in version 400
/*FUNC: 96*/ extern BOOL (*IDE_ExecuteTemplate)(const char*Template, BOOL NewWindow);
...
// Available in version 500
/*FUNC: 97*/ extern const char*(*IDE_GetConnectAs)();
...
//
// Available in version 500
/*FUNC: 98*/ extern BOOL (*IDE_SetConnectionAs)(const char*Username, const char*Password, const char*Database, const char*ConnectAs);
...
//
// Available in version 400
/*FUNC: 100*/ extern const char*(*IDE_GetFileOpenMenu)(int MenuIndex, int *WindowType);
...
//
// Available in version 400
/*FUNC: 102*/ extern void (*IDE_OpenFileExternal)(int WindowType, const char*Data, const char*FileSystem, const char*Tag, const char*Filename);

// Returns the defined filetypes for a specific WindowType.
//
// Available in version 400
/*FUNC: 103*/ extern const char*(*IDE_GetFileTypes)(int WindowType);

// Returns the default extension (without period) for a specific window type.
// Available in version 400
/*FUNC: 104*/ extern const char*(*IDE_GetDefaultExtension)(int WindowType);

// Returns the data of a window. You can use this function to get the data and save it.
//
// Available in version 400
/*FUNC: 105*/ extern const char*(*IDE_GetFiledata)();
...
//
// Available in version 400
/*FUNC: 106*/ extern void (*IDE_FileSaved)(const char*FileSystem, const char*FileTag, const char*Filename);
...
/*FUNC: 107*/ extern BOOL (*IDE_ShowHTML)(const char*Url, const char*Hash, const char*Title, const char*ID);
...
/*FUNC: 108*/ extern BOOL (*IDE_RefreshHTML)(const char*Url, const char*ID, BOOL     BringToFront);
...
/*FUNC: 109*/ extern const char*(*IDE_GetProcEditExtension)(const char*oType);

// Get info about the object opened in a Window. This will only work for Program Windows.
//
// Available in version 512
/*FUNC: 110*/ extern BOOL (*IDE_GetWindowObject) (const char**ObjectType, const char**ObjectOwner, const char**ObjectName, const char**SubObject);
...
// Available in version 510
/*FUNC: 121*/ extern int (*IDE_GetMenuItem)(const const char*MenuName);
...
// Available in version 510
/*FUNC: 132*/ extern const char*(*IDE_GetTranslatedMenuLayout)();
...
//
// Available in version 511
/*FUNC: 148*/ extern const char*(*IDE_TabInfo)(int Index);
...
//
// Available in version 510
/*FUNC: 150*/ extern void (*IDE_CreateToolButton)(int ID, int Index, const char*Name, const char*BitmapFile, int BitmapHandle);
...
//
// Available in version 510
/*FUNC: 162*/ extern const char*(*IDE_BeautifyText)(const char*S);
...
// QUERYDATA, TEST
// Available in version 514
/*FUNC: 165*/ extern BOOL (*IDE_ObjectAction)(const char*Action, const char*ObjectType, const char*ObjectOwner, const char*ObjectName);
...
// Available in version 700
/*FUNC: 166*/ extern BOOL (*IDE_ShowDialog)(const char*Dialog, const char*Param);

// When debuggin is on, this function allows you to add messages in the
// debug.txt file generated.
// Available in version 700
/*FUNC: 173*/ extern void (*IDE_DebugLog)(const char*Msg);

// This function returns a command-line parameter, or a parameter
// specified in the params.ini file.
// Available in version 700
/*FUNC: 174*/ extern const char* (*IDE_GetParamString)(const char*Name);

// This function returns a command-line parameter, or a parameter
// specified in the params.ini file.
// Available in version 700
/*FUNC: 175*/ extern BOOL (*IDE_GetParamBool)(const char*Name);
...
/*FUNC: 180*/ extern void (*IDE_CommandFeedback)(int FeedbackHandle, const char*S);
...
// and cols.
// Available in version 516
/*FUNC: 192*/ extern const char* (*IDE_ResultGridCell)(int Col, int Row);
...
/*FUNC: 200*/ extern BOOL (*IDE_Authorized)(const char*Category, const char*Name, const char*SubName);
...
// Available in version 600
/*FUNC: 203*/ extern const char* (*IDE_AuthorizationItems)(const char*Category);
...
// Available in version 600
/*FUNC: 204*/ extern void (*IDE_AddAuthorizationItem)(int PlugInID, const char*Name);
...
// preference sets.
// Available in version 600
/*FUNC: 210*/ extern const char* (*IDE_GetPersonalPrefSets)();

// Returns a list of all default preference sets.
// Available in version 600
/*FUNC: 211*/ extern const char* (*IDE_GetDefaultPrefSets)();
...
// Available in version 600
/*FUNC: 212*/ extern BOOL (*IDE_GetPrefAsString)(int PlugInID, const char* PrefSet, const char*Name, const char*Default);

// As IDE_GetPrefAsString, but for integers.
// Available in version 600
/*FUNC: 213*/ extern int (*IDE_GetPrefAsInteger)(int PlugInID, const char* PrefSet, const char*Name, BOOL Default);

// As IDE_GetPrefAsString, but for booleans.
// Available in version 600
/*FUNC: 214*/ extern BOOL (*IDE_GetPrefAsBool)(int PlugInID, const char* PrefSet, const char*Name, BOOL Default);
...
// Available in version 600
/*FUNC: 215*/ extern BOOL (*IDE_SetPrefAsString)(int PlugInID, const char*PrefSet, const char*Name, const char*Value);

// As IDE_SetPrefAsString, but for integers.
// Available in version 600
/*FUNC: 216*/ extern BOOL (*IDE_SetPrefAsInteger)(int PlugInID, const char*PrefSet, const char*Name, int Value);

// As IDE_SetPrefAsString, but for booleans.
// Available in version 600
/*FUNC: 217*/ extern BOOL (*IDE_SetPrefAsBool)(int PlugInID, const char*PrefSet, const char*Name, BOOL Value);

// Returns the value of a preference. The names can be found in the
// preference ini file under the [Preferences] section.
// Available in version 700
/*FUNC: 218*/ extern const char* (*IDE_GetGeneralPref)(const char*Name);
...
/*FUNC: 219*/ extern BOOL (*IDE_PlugInSetting)(int PlugInID, const char*Setting, const char*Value);

// Returns the number of overloads for a specific procedure.
// Result < 0 = Procedure doesn`t exist
// Result > 0 = overload count
// Available in version 700
/*FUNC: 220*/ extern int (*IDE_GetProcOverloadCount)(const char*Owner, const char*PackageName, const char*ProcedureName);
...
// Available in version 700
/*FUNC: 221*/ extern int (*IDE_SelectProcOverloading)(const char*Owner, const char*PackageName, const char*ProcedureName);
...
// Available in version 700
/*FUNC: 230*/ extern const char* (*IDE_GetSessionValue)(const char*Name);
...
/*FUNC: 40*/ extern int (*SQL_Execute)(const char*SQL);
...
/*FUNC: 44*/ extern const char*(*SQL_Field)(int Field);

// Returns the fieldname specified by the Field parameter.
/*FUNC: 45*/ extern const char*(*SQL_FieldName)(int Field);
...
/*FUNC: 46*/ extern int (*SQL_FieldIndex)(const char*Name);
...
// Available in version 700
/*FUNC: 53*/ extern const char* (*SQL_GetDBMSGetOutput)();

// This function declares a variable. Call this for al variables you use in the
// statement you pass in SQL_Execute.
// Available in version 700
/*FUNC: 54*/ extern void (*SQL_SetVariable)(const char*Name, const char*Value);

// This function will return the value of a variable.
// Available in version 700
/*FUNC: 55*/ extern const char* (*SQL_GetVariable)(const char*Name);
...
// IDE_SetConnection
// Available in version 301
/*FUNC: 48*/ extern const char*(*SQL_ErrorMessage)();
